...
uv run scripts/01_fetch_data.py --mtg-start 2026-08-01   # quick check instead
...
uv run python scripts/01_fetch_data.py --mtg-start <30 days ago>   # quick real-data check
```
